...
export const GLOBAL_WEB3_DISCOVERY_SOURCES: GlobalDiscoverySource[] = [
  ...
  { id: "substack", name: "Substack/Newsletters", side: "supply", category: "media", signalTypes: ["newsletter", "writer", "audience"], trust: 72, freshness: "daily", status: "active" },
  { id: "podcasts", name: "Crypto Podcasts", side: "supply", category: "media", signalTypes: ["podcast", "guest", "audience"], trust: 70, freshness: "daily", status: "active" },
