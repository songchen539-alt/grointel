    ...
    <div className="min-h-screen bg-black text-white">
      <div className="mx-auto max-w-2xl px-6 py-24 md:py-32 text-center">
        ...
        <h1 className="text-4xl md:text-5xl font-bold tracking-tight mb-4">
          Let GroIntel understand your capabilities
        </h1>
        <p className="text-gray-500 text-lg mb-10 max-w-lg mx-auto">
          Paste your public profile. We analyze your capabilities, audience, markets, and growth potential.
        </p>

        <form onSubmit={handleSubmit} className="max-w-md mx-auto">
          <div className="flex gap-2">
            <input type="text" value={profileUrl} onChange={(e) => setProfileUrl(e.target.value)}
              placeholder="https://youtube.com/@channel, https://linkedin.com/company/..."
        ...
        <div className="mt-16 text-left">
          <h3 className="text-sm font-medium text-gray-400 mb-3 uppercase tracking-wider">Sample profiles</h3>
          <div className="flex flex-wrap gap-2">
            {["https://youtube.com/@channel", "https://linkedin.com/company/agency", "https://github.com/dev", "https://substack.com/@writer"].map((s) => (
              <button key={s} onClick={() => setProfileUrl(s)}
