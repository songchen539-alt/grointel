...
export class CapabilityRegistry {
  ...
  private initDefaults(): void {
    ...
    const defs: CapabilityDefinition[] = [
      ...
      { id: "civilization.register", name: "Register Node", description: "Register a new civilization node", layer: "civilization", input_schema: {}, output_schema: {}, required_permissions: "execute", risk_level: "medium", available: true, version: 1 },
      { id: "civilization.consensus", name: "Create Consensus", description: "Create and vote on a consensus proposal", layer: "civilization", input_schema: {}, output_schema: {}, required_permissions: "execute", risk_level: "low", available: true, version: 1 },
      { id: "application.register", name: "Register Application", description: "Register a new application", layer: "application", input_schema: {}, output_schema: {}, required_permissions: "execute", risk_level: "medium", available: true, version: 1 },
      { id: "application.session", name: "Start Application Session", description: "Start an application session", layer: "application", input_schema: {}, output_schema: {}, required_permissions: "execute", risk_level: "low", available: true, version: 1 },
